package com.zhongnongfuan.app.receiver;
...
public class MyReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		try {
			...
			String sb = printBundle(bundle);
			Logger.d(TAG, "[MyReceiver] onReceive - " + intent.getAction() + ", extras: " + sb);
			...
			if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
				...
				//*******************************
				Logger.d(TAG, "[MyReceiver] 用户点击打开了通知 。。。。。。。。。。 获取的消息为：：：" + bundle.toString());
				//打开自定义的Activity
	...
	private static String printBundle(Bundle bundle) {
		...
		for (String key : bundle.keySet()) {
			if (key.equals(JPushInterface.EXTRA_NOTIFICATION_ID)) {
				...
				String s = sb.substring(sb.indexOf("value:"));
				Logger.v("", "截取的设备号为：：： " + s);
